...
# Duplicate that continues on, and adds 'dict' function, etc.. Separated for my own ease when reviewing my notes
...
# Now we explore the dict function which is literally a dictionary like in the real world, words and definitions in reg terms, in programming THEY ARE CALLED KEYS AND VALUES, so we are associating something with something else when using dict, (btw a list is just a set of values) 



# This is the idea we are working with... associating each index of 'students' with each index of 'houses' respectively to output the correct string values associations. This breaks down very quickly with large data sets so I'll make this code a comment in itself and implement the refined versions through thee use of 'dict'(s) or "dictionaries"
...
#Below I use curly braces {} to make a 'dict' or "dictionary"
...
#sticking with the above assigned variable lets explore the printing of this dictionary and refine our process using features of dictionaries and lists
...
# OR FOR BETTER READBILITY BELOW
...
# to combine name and house below

for student in students:
    print(student, students[student], sep=", ")

# Note the altered print function with sep, in this case it will add a comma and a space after student and before students[student]




# Adding a third asssociated category to the dictionary and composing a list of dictionaries below
...
# How many words in each dictionary? 3. How many definitions in each? 3. Let's look at an example. Take Heromione's dictionary, there are three words/keys and 3 definitions/values. The words/keys are "name, house, patronus," and the definitions/values are "Hermione, Gryffindor, and Otter"
